<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Invoice.aspx.cs" Inherits="Ordering_System.User.Invoice" %>
             ...
             <asp:Repeater ID="rOrderItem" runat="server">
                 ...
                 <ItemTemplate>
                     <tr>
                         ...
                         <td><%# Eval("OrderNo") %></td>
                         <td><%# Eval("Name") %></td>
                         <td><%# string.IsNullOrEmpty( Eval("Price").ToString())?"":"Rs"+ " " + Eval("Price") %></td>
                         <td><%# Eval("Quantity") %></td>
